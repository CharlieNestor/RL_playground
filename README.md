...
This project is a Reinforcement Learning playground dedicated to implementing classical RL algorithms in a clear and instructive way. The implementations adhere closely to the theoretical foundations laid out in the Sutton & Barto textbook ("Reinforcement Learning: An Introduction") and the broader history of RL.
...
- `utils/`: Contains utilities, particularly the visualization functions that are central to the pedagogical goal of this project.
- **Jupyter Notebooks**: Several notebooks (`.ipynb`) that tie together the algorithms, environments, and visualizations to provide an interactive understanding of the learning processes:
  - `DP_algorithms_tabular.ipynb`
  - `Model_free_evaluation_tabular.ipynb`
  - `Model_free_control_tabular.ipynb`
